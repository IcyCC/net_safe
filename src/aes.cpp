...
long Aes256::encrypt_continue(const ByteArray& plain, ByteArray& encrypted)
{
...
long Aes256::encrypt_continue(const unsigned char* plain, const long plain_length, ByteArray& encrypted)
{
	long i = 0;
...
long Aes256::encrypt_end(ByteArray& encrypted)
{
	if (m_buffer_pos > 0) {
...
long Aes256::decrypt_start(const long encrypted_length)
{
	 unsigned char j;
...
long Aes256::decrypt_continue(const ByteArray& encrypted, ByteArray& plain)
{
...
long Aes256::decrypt_continue(const unsigned char* encrypted, const long encrypted_length, ByteArray& plain)
{
	long i = 0;
...
long Aes256::decrypt_end(ByteArray& plain)
{
	return plain.size();
}
