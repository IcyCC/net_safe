...
const int move_time[16] = {1,1,2,2,2,2,2,2,1,2,2,2,2,2,2,1};




void myPermutation(char *In,char *Out,int n,const char *P)
{
    int i=0;
    for(i=0; i<n; i++)
        *(Out+i)=*(In+*(P+i)-1);
...
void sub_key(char* K,char (*SK)[49])
{
...
void myf(char* L,char* R,char* SK)
{
    int i=0,j=0;
    int row,col;
